...
class CarrosControllerTest < ActionController::TestCase
  ...
  test "should create carro" do
    assert_difference('Carro.count') do
      post :create, carro: { ano: @carro.ano, cor: @carro.cor, idRota: @carro.idRota, idUser: @carro.idUser, marca: @carro.marca, modelo: @carro.modelo, placa: @carro.placa }
    end
  ...
  test "should update carro" do
    put :update, id: @carro, carro: { ano: @carro.ano, cor: @carro.cor, idRota: @carro.idRota, idUser: @carro.idUser, marca: @carro.marca, modelo: @carro.modelo, placa: @carro.placa }
    assert_redirected_to carro_path(assigns(:carro))
  end
