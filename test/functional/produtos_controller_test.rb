...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, idEntrega: @produto.idEntrega, idUser: @produto.idUser, peso: @produto.peso, tamanho: @produto.tamanho, tipocarga_id: @produto.tipocarga_id }
    end
  ...
  test "should update produto" do
    put :update, id: @produto, produto: { descricao: @produto.descricao, idEntrega: @produto.idEntrega, idUser: @produto.idUser, peso: @produto.peso, tamanho: @produto.tamanho, tipocarga_id: @produto.tipocarga_id }
    assert_redirected_to produto_path(assigns(:produto))
  end
